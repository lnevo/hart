...
Updated: 2026-08-27 — **120L** stays westbound on McKeesport under **120R**, but SML still requires **McKees Rocks** unoccupied (same hold as when the lamp sat on that track). Reload **USS CTC**. Do not run it with CATS CTC.
