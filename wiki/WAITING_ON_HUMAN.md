...
## Parked for later review (not a gate)

- **Cursor skills + MCPs** — reusable agent tooling inventory (do not start building until reviewed): [`projects/agent-skills-and-mcps.md`](projects/agent-skills-and-mcps.md)
