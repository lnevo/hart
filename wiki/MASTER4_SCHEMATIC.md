...
The USS track diagram is `jmri/layouts/hart/ctc/GUIObjects.xml` (**v67**, 20 packed columns). Lever UniqueIDs and JMRI beans are still the 12-column machine / Switch 100–119; lock toggles on 119/118/104–106 are GUI-only Internal sensors. PanelPro `tables.xml` is still the pre-Master 4 board.
...
Static preview: `cats/screenshots/master4/uss_ctc_v67_preview.png`. Earlier Master 4 studies are `uss_ctc_v22`–`v66`.
