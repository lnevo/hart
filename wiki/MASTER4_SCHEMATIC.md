...
- USS CTC `GUIObjects.xml` is **v57**, generated from live CATS Master 4 (`gen_ctc_track_plan.py`). One cell tile per Digicon track piece. `tables.xml` still embeds the pre-Master 4 paneleditor until that is replaced.
