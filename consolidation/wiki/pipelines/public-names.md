...
Interactive HTML (regenerated by `build_site.py`):

- [`html/review/device-map.html`](../../html/review/device-map.html) — merged map + legacy role column
- [`cutover/names-d2/`](../../cutover/names-d2/) — promotion checklist
