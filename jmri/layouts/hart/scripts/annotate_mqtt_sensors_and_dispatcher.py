...
LAP_SECTIONS = [
    ...
    ("Main West", "OS 111a (East End)", "OS 100 (Brick)"),
    ...
    ("OS 115 (Princess)", "McKees Rocks", "OS 113b (Princess)"),
    ("OS 113b (Princess)", "OS 115 (Princess)", "West Main Ext"),
]

# First and last section are the same (continuous lap).
TRANSIT_SEQ = [
    ("West Main Ext", FORWARD),
    ("OS 111a (East End)", FORWARD),
    ("Main West", FORWARD),
    ("OS 100 (Brick)", FORWARD),
    ...
    ("OS 115 (Princess)", FORWARD),
    ("OS 113b (Princess)", FORWARD),
    ("West Main Ext", FORWARD),
]
