...
EH_ROW_STATIONS = frozenset({"Track EH-1", "Track EH-2", "Track EH-3"})

# Progress icon position; the clickable MoveTo icon sits PAIR_DX to its right.
# Track Main West / Track Main East / Track Brick-Plane keep the progress lamp and pull MoveTo in.
# The other original five pull progress right to meet the existing MoveTo.
STATION_ICON_POSITIONS = {
    "Track Brick-Plane": (240, 293),
    "Track East Main Ext": (376, 390),
    "Track Main West": (943, 230),
    "Track Main East": (943, 520),
    "Track West Main Ext": (1416, 210),
    "Track East Lead": (1416, 345),
    "Track McKees Rocks": (1706, 185),
    "Track McKeesport": (1706, 345),
    ...
    "Track S-3": (943, 438),
    "Track S-4": (943, 480),
    # Track Scale (old T1) / Track Barn (old T6) left of the shortened house stubs.
    "Track Scale": (410, 266),
    "Track Barn": (490, 266),
...
STATION_OCCUPANCY = {
    "Track Brick-Plane": "Block 4-6",
    "Track East Main Ext": "Block 4-7",
    "Track Main West": "Block 2-1",
    "Track Main East": "Block 2-3",
    "Track West Main Ext": "Block 1-8",
    "Track East Lead": "Block 1-7",
    "Track McKees Rocks": "Block 1-1",
    "Track McKeesport": "Block 1-2",
    "Track EH-1": "Block 13-7",
    "Track EH-2": "Block 13-6",
    "Track EH-3": "Block 13-5",
    "Track S-R": "Block 2-8",
    "Track S-1": "Block 2-7",
    "Track S-2": "Block 2-6",
    "Track S-3": "Block 2-5",
    "Track S-4": "Block 2-4",
    "Track Scale": "Block 4-8",
    "Track Barn": "Block 13-1",
    "Track W-1": "Block 4-4",
    "Track W-2": "Block 4-3",
    "Track K-1": "Block 1-4",
    "Track K-2": "Block 1-3",
...
STATION_DISPLAY_NAMES = {
    "Track Brick-Plane": "Brk-Pln",
    "Track East Main Ext": "E Main",
    "Track Main West": "Main W",
    "Track Main East": "Main E",
    "Track West Main Ext": "W Main",
    "Track East Lead": "E Lead",
    "Track McKees Rocks": "McK Rks",
    "Track McKeesport": "McKport",
