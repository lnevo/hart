...
EH_ROW_STATIONS = frozenset({"OS EH-1", "OS EH-2", "OS EH-3"})

# Progress icon position; the clickable MoveTo icon sits PAIR_DX to its right.
# OS Main West / OS Main East / OS Brick-Plane keep the progress lamp and pull MoveTo in.
# The other original five pull progress right to meet the existing MoveTo.
STATION_ICON_POSITIONS = {
    "OS Brick-Plane": (240, 293),
    "OS East Main Ext": (376, 390),
    "OS Main West": (943, 230),
    "OS Main East": (943, 520),
    "OS West Main Ext": (1416, 210),
    "OS East Lead": (1416, 345),
    "OS McKees Rocks": (1706, 185),
    "OS McKeesport": (1706, 345),
    ...
    "OS S-3": (943, 438),
    "OS S-4": (943, 480),
    # OS Scale (old T1) / OS Barn (old T6) left of the shortened house stubs.
    "OS Scale": (410, 266),
    "OS Barn": (490, 266),
...
STATION_OCCUPANCY = {
    ...
    "OS Main East": "Block 2-3",
    "OS West Main Ext": "Block 1-8",
    "OS East Lead": "Block 1-7",
    "OS McKees Rocks": "Block 1-1",
    "OS McKeesport": "Block 1-2",
    "OS EH-1": "Block 13-7",
    "OS EH-2": "Block 13-6",
    "OS EH-3": "Block 13-5",
    "OS S-R": "Block 2-8",
...
STATION_DISPLAY_NAMES = {
    "OS Brick-Plane": "Brk-Pln",
    "OS East Main Ext": "E Main",
    "OS Main West": "Main W",
    "OS Main East": "Main E",
    "OS West Main Ext": "W Main",
    "OS East Lead": "E Lead",
    "OS McKees Rocks": "McK Rks",
    "OS McKeesport": "McKport",
    "OS EH-1": "OS EH-1",
    "OS EH-2": "OS EH-2",
    "OS EH-3": "OS EH-3",
    "OS S-R": "OS S-R",
