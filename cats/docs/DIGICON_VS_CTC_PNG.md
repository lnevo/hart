...
|----|------|--------------|
| 100 | Brick | Main plant; continuing = OS Brick-Plane |
| 101 | Brick | Yard / OS Main West side of Brick |
| 102 | Plane | Main plant; east = OS East Main Ext |
| 117 / 117b | West Yard | Entry / crossover on main ↔ EME |
| 119, 118, 116 | West Yard / engine | Ladder rungs |
| 103–106 | South Yard | Ladder |
| 111 / 111b | East End | Crossover to OS West Main Ext |
| 107–110 | East End | Ladder |
| 112 | East End | Main → OS East Lead |
| 113–115 | Princess | Loops (OS McKees Rocks / OS McKeesport) |
