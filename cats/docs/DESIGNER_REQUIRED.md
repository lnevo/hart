...
1. Gate 1: [`GATE1_BRICK_PLANE.md`](GATE1_BRICK_PLANE.md) — Brick → OS Brick-Plane → Plane  
...
Abuts Armstrong **fragments** so Gate 1 has a long HORIZONTAL OS Brick-Plane between Brick and Plane. Use for MQTT smoke tests only. **Designer Gate 1 replaces it** for a representative panel.
