...
| South Yard | **Scale** → **Barn** (between 7 and 13) → **EH-1 / EH-2 / EH-3** + **Switch 13** + ladder **15 / 17 / 19 / 21**; **Switch 7** Barn xover. Rebuild: `python3 cats/scripts/render_south_yard_station_map.py`. |
