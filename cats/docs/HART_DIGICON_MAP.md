...
|---|-----------|
| 1 | Labels |
| 2 | Upper parallel: OS Main West → OS 23a/b → OS West Main Ext → OS 35b → OS 39 → OS McKees Rocks |
| 3 | Main spine: Brick → 100-102 (HORIZONTAL) → Plane → EME → 117b → OS Main East → 112 → OS East Lead → 113 → 114 → OS McKeesport |
| 4 | W-116–119 + S-103–106 + East End 107–110 |
| 5 | OS Scale/T6 + Yard Tracks 1–5 |
...
Gate-1 Designer draw remains authoritative for Neville LH100 geography until Mac accept promotes a fuller board. LE keeps OS Brick-Plane on the **continuing HORIZONTAL** (not a diverge into Plane).
