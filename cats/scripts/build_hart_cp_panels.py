...
def build_101() -> None:
    ...
    H((2, 1))
    nm((2, 1), "LEFT", "OS 101 (Brick)")
    plant((3, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 101 (Brick)", "RIGHT", "TOL38")
...
def build_100() -> None:
    ...
    _run(0, 1, 1, "from 101")
    cut((1, 1), "RIGHT", (2, 1), "LEFT")
    H((2, 1)); nm((2, 1), "LEFT", "OS 100 (Brick)")
    plant((3, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 100 (Brick)", "RIGHT", "TOL3")
    cut((3, 1), "RIGHT", (4, 1), "LEFT")
...
def build_102() -> None:
    ...
    cut((1, 1), "RIGHT", (2, 1), "LEFT")
    H((2, 1))
    nm((2, 1), "LEFT", "OS 102 (Plane)")
    plant((3, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 102 (Plane)", "RIGHT", "TOL42")
...
def build_117() -> None:
    ...
    H((3, 1)); nm((3, 1), "LEFT", "OS 117 (West Yard)")
    plant((4, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 117 (West Yard)", "RIGHT", "TO117")
    cut((4, 1), "RIGHT", (5, 1), "LEFT")
    _run(5, 8, 1, "West Lead")
    _stub_e(8, 1)
    # mate on Main East
    cut((4, 1), "BOTTOM", (4, 2), "TOP")
    H((3, 2)); nm((3, 2), "LEFT", "OS 117b (West Yard)")
    plant((4, 2), ["HORIZONTAL", "UPPERSLASH"], "OS 117b (West Yard)", "RIGHT", "TO117")
...
def build_116_et() -> None:
    """South Yard map: ET-1/2/3 hang off West Lead at 116 / TO1."""
    H, plant, nm, cut = le.H, le.plant, le.nm, le.cut
    _clear()
    _run(0, 2, 2, "West Lead")
    cut((2, 2), "RIGHT", (3, 2), "LEFT")
    H((3, 2))
    nm((3, 2), "LEFT", "OS 116 (West Yard)")
    # H+US: SP LEFT; TOP = ET; RIGHT = continue West Lead
    plant((4, 2), ["HORIZONTAL", "UPPERSLASH"], "OS 116 (West Yard)", "RIGHT", "TO1")
    cut((4, 2), "RIGHT", (5, 2), "LEFT")
    ...
    H((4, 1))
    nm((4, 1), "LEFT", "OS 118 (West Yard)")
    plant((5, 1), ["HORIZONTAL", "UPPERSLASH"], "OS 118 (West Yard)", "RIGHT", "TO11")
    cut((5, 1), "RIGHT", (6, 1), "LEFT")
    H((6, 1))
    nm((6, 1), "LEFT", "ET-1")
    cut((6, 1), "RIGHT", (7, 1), "LEFT")
    H((7, 1))
    nm((7, 1), "LEFT", "OS 119 (West Yard)")
    plant((8, 1), ["HORIZONTAL", "UPPERSLASH"], "OS 119 (West Yard)", "RIGHT", "TO10")
...
def build_103() -> None:
    ...
    _run(0, 2, 1, "West Lead")
    cut((2, 1), "RIGHT", (3, 1), "LEFT")
    H((3, 1)); nm((3, 1), "LEFT", "OS 103 (South Yard)")
    plant((4, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 103 (South Yard)", "RIGHT", "TOR14")
    cut((4, 1), "RIGHT", (5, 1), "LEFT")
    _run(5, 10, 1, "S-1")
    _stub_e(10, 1)
    le.GRID[(4, 2)] = ["UPPERBACKSLASH"]
...
def build_104() -> None:
    ...
    _run(0, 1, 1, "from 103")
    cut((1, 1), "RIGHT", (2, 1), "LEFT")
    H((2, 1)); nm((2, 1), "LEFT", "OS 104 (South Yard)")
    plant((3, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 104 (South Yard)", "RIGHT", "TOL15")
    cut((3, 1), "RIGHT", (4, 1), "LEFT")
    _run(4, 9, 1, "S-2")
    _stub_e(9, 1)
    le.GRID[(3, 2)] = ["UPPERBACKSLASH"]
...
def build_105() -> None:
    ...
    _run(0, 1, 1, "from 104")
    cut((1, 1), "RIGHT", (2, 1), "LEFT")
    H((2, 1)); nm((2, 1), "LEFT", "OS 105 (South Yard)")
    plant((3, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 105 (South Yard)", "RIGHT", "TOL17")
    cut((3, 1), "RIGHT", (4, 1), "LEFT")
    _run(4, 9, 1, "S-3")
    _stub_e(9, 1)
    le.GRID[(3, 2)] = ["UPPERBACKSLASH"]
...
def build_106() -> None:
    ...
    _run(0, 1, 1, "from 105")
    cut((1, 1), "RIGHT", (2, 1), "LEFT")
    H((2, 1)); nm((2, 1), "LEFT", "OS 106 (South Yard)")
    plant((3, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 106 (South Yard)", "RIGHT", "TOL19")
    cut((3, 1), "RIGHT", (4, 1), "LEFT")
    _run(4, 9, 1, "S-4")
    _stub_e(9, 1)
    le.GRID[(3, 2)] = ["UPPERBACKSLASH"]
...
def build_111() -> None:
    ...
    cut((2, 1), "RIGHT", (3, 1), "LEFT")
    H((3, 1)); nm((3, 1), "LEFT", "OS 111b (East End)")
    plant((4, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 111a (East End)", "RIGHT", "TO111")
    cut((4, 1), "RIGHT", (5, 1), "LEFT")
...
def build_110() -> None:
    ...
    cut((2, 1), "RIGHT", (3, 1), "LEFT")
    H((3, 1)); nm((3, 1), "LEFT", "OS 110 (East End)")
    plant((4, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 110 (East End)", "RIGHT", "TOL6")
    cut((4, 1), "RIGHT", (5, 1), "LEFT")
...
def build_109() -> None:
    ...
    _run(0, 1, 1, "from 110")
    cut((1, 1), "RIGHT", (2, 1), "LEFT")
    H((2, 1)); nm((2, 1), "LEFT", "OS 109 (East End)")
    plant((3, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 109 (East End)", "RIGHT", "TOR7")
    cut((3, 1), "RIGHT", (4, 1), "LEFT")
    _run(4, 8, 1, "S-2")
    _stub_e(8, 1)
    le.GRID[(3, 2)] = ["UPPERBACKSLASH"]
...
def build_108() -> None:
    ...
    _run(0, 1, 1, "from 109")
    cut((1, 1), "RIGHT", (2, 1), "LEFT")
    H((2, 1)); nm((2, 1), "LEFT", "OS 108 (East End)")
    plant((3, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 108 (East End)", "RIGHT", "TOR9")
    cut((3, 1), "RIGHT", (4, 1), "LEFT")
    _run(4, 8, 1, "S-3")
    _stub_e(8, 1)
    le.GRID[(3, 2)] = ["UPPERBACKSLASH"]
...
def build_107() -> None:
    ...
    _run(0, 1, 1, "from 108")
    cut((1, 1), "RIGHT", (2, 1), "LEFT")
    H((2, 1)); nm((2, 1), "LEFT", "OS 107 (East End)")
    plant((3, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 107 (East End)", "RIGHT", "TOR11")
    cut((3, 1), "RIGHT", (4, 1), "LEFT")
    _run(4, 8, 1, "S-4")
    _stub_e(8, 1)
    le.GRID[(3, 2)] = ["UPPERBACKSLASH"]
...
def build_112() -> None:
    ...
    _run(0, 2, 1, "Main East")
    cut((2, 1), "RIGHT", (3, 1), "LEFT")
    H((3, 1)); nm((3, 1), "LEFT", "OS 112 (East End)")
    plant((4, 1), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 112 (East End)", "RIGHT", "TOL23")
    cut((4, 1), "RIGHT", (5, 1), "LEFT")
...
def build_113() -> None:
    ...
    _run(0, 2, 1, "Main West")
    cut((2, 1), "RIGHT", (3, 1), "LEFT")
    H((3, 1)); nm((3, 1), "LEFT", "OS 113b (Princess)")
    plant((4, 1), ["HORIZONTAL", "UPPERSLASH"], "OS 113b (Princess)", "RIGHT", "TO113")
    cut((4, 1), "RIGHT", (5, 1), "LEFT")
    _run(5, 9, 1, "Main West")
    _stub_e(9, 1)
    _run(0, 2, 2, "Main East")
    cut((2, 2), "RIGHT", (3, 2), "LEFT")
    H((3, 2)); nm((3, 2), "LEFT", "OS 113a (Princess)")
    plant((4, 2), ["HORIZONTAL", "LOWERBACKSLASH"], "OS 113a (Princess)", "RIGHT", "TO113")
    cut((4, 2), "TOP", (4, 1), "BOTTOM")
    cut((4, 2), "RIGHT", (5, 2), "LEFT")
    _run(5, 9, 2, "Main East")
    _stub_e(9, 2)
...
def build_115() -> None:
    ...
    _run(0, 2, 1, "Main West")
    cut((2, 1), "RIGHT", (3, 1), "LEFT")
    H((3, 1)); nm((3, 1), "LEFT", "OS 115 (Princess)")
    plant((4, 1), ["HORIZONTAL", "UPPERSLASH"], "OS 115 (Princess)", "RIGHT", "TOL29")
    cut((4, 1), "RIGHT", (5, 1), "LEFT")
    _run(5, 10, 1, "K-1")
    _stub_e(10, 1)
    le.LABELS[:] = [
...
def build_114() -> None:
    ...
    _run(0, 2, 1, "Main East")
    cut((2, 1), "RIGHT", (3, 1), "LEFT")
    H((3, 1)); nm((3, 1), "LEFT", "OS 114 (Princess)")
    plant((4, 1), ["HORIZONTAL", "UPPERSLASH"], "OS 114 (Princess)", "RIGHT", "TOR36")
    nm((4, 1), "RIGHT", "OS 114 (Princess)")
    cut((4, 1), "RIGHT", (5, 1), "LEFT")
    _run(5, 10, 1, "K-2")
    _stub_e(10, 1)
    le.LABELS[:] = [
...
CPS: list[tuple[str, str, str, BuildFn]] = [
    ...
    ("116", "South Yard", "CP 116 — West Lead / ET-1...3", build_116_et),
