...
def build_triple(mqtt: bool) -> ET.Element:
    ...
    _rename_blocks_in_x_range(
        ...
        24,
        {
            "OS 103 (South Yard)": "S-1",
            "OS 104 (South Yard)": "S-2",
            "OS 105 (South Yard)": "S-3",
            "OS 106 (South Yard)": "S-4",
            "SidingLeft": "S-1",
            "SidingSiding": "S-2",
            "SidingMain": "S-3",
            "SidingRight": "S-4",
...
def build_chubb(mqtt: bool) -> ET.Element:
    ...
    rename_blocks(
        root,
        {
            ...
            # not top A/B OS 117 (M2S1302 / Scale–Barn side).
            ...
            "dBlock 4": "OS 119",
            "dBlock 5": "Barn",
            "dBlock 6": "OS 117 (Barn)",  # TO117 top A/B (Scale/Barn side)
