...
def build_stacked(mqtt: bool) -> ET.Element:
    ...
    _rename_blocks_in_x_range(
        ...
        {
            "Track 5": "Track 9",
            "Main West Brick–Plane": "Track 27",
            "Spur": "Track 9",
            "Intermediate2": "Track 27",
        },
        y0=10,
        y1=20,
    )
...
def build_triple(mqtt: bool) -> ET.Element:
    ...
    _rename_blocks_in_x_range(
        ...
        {
            "Track 13": "Track 13",
            "Track 7 (Barn)": "Track 7 (Barn)",
            "Track 11": "Track 11",
            "Scale": "Scale",
            "W-2": "W-2",
            "YardMain": "Track 13",
            "YardRight": "Track 7 (Barn)",
            "Intermediate1": "Track 11",
            "Yard": "Scale",
            "Yard2": "W-2",
        },
        y0=9,
    ...
    _rename_blocks_in_x_range(
        ...
        {
            "Track 5": "S-5",
            "Main West Brick–Plane": "Track 9",
            "Spur": "S-5",
            "Intermediate2": "Track 9",
        },
        y0=9,
        y1=15,
    )
    ...
    _rename_blocks_in_x_range(
        ...
        15,
        {
            ...
            "Track 21": "Track 31",
            "SidingLeft": "Track 25",
            "SidingSiding": "Track 27",
            "SidingMain": "Track 29",
            "SidingRight": "Track 31",
        },
        y0=17,
        y1=24,
    )
    _rename_blocks_in_x_range(
        ...
        22,
        {
            ...
            "Track 9": "Track 33",
            "Track 5": "Track 23a",
            "Main West Brick–Plane": "Track 33",
            "Spur": "Track 23a",
            "Intermediate2": "Track 33",
        },
        y0=17,
        y1=24,
    )
...
def build_chubb(mqtt: bool) -> ET.Element:
    ...
    rename_blocks(
        root,
        {
            ...
            # Main East ↔ East Main Ext uses TO117 bottom C/D = Track 7b (M2S1303),
            # not top A/B Track 7 (M2S1302 / Scale–Barn side).
            "aBlock 6": "Track 7b (Barn)",
            "aBlock 7": "Main East",
            "aBlock 8": "Track 33",
            "aBlock 9": "East Lead",
            ...
            "dBlock 4": "Track 9",
            "dBlock 5": "Barn",
            "dBlock 6": "Track 7 (Barn)",  # TO117 top A/B (Scale/Barn side)
            "dBlock 7": "W-1",
            "dBlock 8": "W-2",
            "dBlock 9": "EH-1",
            "dBlock 10": "S-1",
