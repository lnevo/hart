...
def build_stacked(mqtt: bool) -> ET.Element:
    ...
    _rename_blocks_in_x_range(
        ...
        {
            "OS 116": "South Yard 1",
            "OS 117 (Barn)": "South Yard 2",
            "OS 118": "South Yard 3",
            "South Yard Scale": "South Yard 4",
            "West Yard 2": "South Yard 5",
            "YardMain": "South Yard 1",
            "YardRight": "South Yard 2",
            "Intermediate1": "South Yard 3",
            "Yard": "South Yard 4",
            "Yard2": "South Yard 5",
        },
        y0=10,
    ...
    _rename_blocks_in_x_range(
        ...
        17,
        {
            "OS 103 (South Yard)": "South Yard West",
            "OS 104 (South Yard)": "Engine House 1",
            "OS 105 (South Yard)": "Engine House 2",
            "OS 106 (South Yard)": "Engine House 3",
            "SidingLeft": "South Yard West",
            "SidingSiding": "Engine House 1",
            "SidingMain": "Engine House 2",
            "SidingRight": "Engine House 3",
        },
        y0=10,
        y1=20,
    )
    _rename_blocks_in_x_range(
        ...
        {
            "OS 102 (Plane)": "OS 119",
            "Main West Brick–Plane": "OS 108 (East End)",
            "Spur": "OS 119",
...
def build_triple(mqtt: bool) -> ET.Element:
    ...
    _rename_blocks_in_x_range(
        ...
        {
            "OS 116": "OS 116",
            "OS 117 (Barn)": "OS 117 (Barn)",
            "OS 118": "OS 118",
            "South Yard Scale": "South Yard Scale",
            "West Yard 2": "West Yard 2",
            "YardMain": "OS 116",
            "YardRight": "OS 117 (Barn)",
            "Intermediate1": "OS 118",
            "Yard": "South Yard Scale",
            "Yard2": "West Yard 2",
        },
        y0=9,
        y1=15,
    ...
    _rename_blocks_in_x_range(
        ...
        24,
        {
            "OS 103 (South Yard)": "South Yard 1",
            "OS 104 (South Yard)": "South Yard 2",
            "OS 105 (South Yard)": "South Yard 3",
            "OS 106 (South Yard)": "South Yard 4",
            "SidingLeft": "South Yard 1",
            "SidingSiding": "South Yard 2",
            "SidingMain": "South Yard 3",
            "SidingRight": "South Yard 4",
        },
        y0=9,
        y1=15,
    )
    _rename_blocks_in_x_range(
        ...
        31,
        {
            "OS 102 (Plane)": "South Yard 5",
            "Main West Brick–Plane": "OS 119",
            "Spur": "South Yard 5",
            "Intermediate2": "OS 119",
        },
        y0=9,
        y1=15,
    )
    ...
    _rename_blocks_in_x_range(
        ...
        15,
        {
            "South Yard 1": "OS 107 (East End)",
            "South Yard 2": "OS 108 (East End)",
            "South Yard 3": "OS 109 (East End)",
            "South Yard 4": "OS 110 (East End)",
    ...
    _rename_blocks_in_x_range(
        ...
        22,
        {
            "South Yard 5": "OS 111a (East End)",
            "OS 119": "OS 112 (East End)",
            "OS 102 (Plane)": "OS 111a (East End)",
            "Main West Brick–Plane": "OS 112 (East End)",
    ...
    _rename_blocks_in_x_range(
        ...
        40,
        {
            ...
            "South Yard East": "South Yard East",
...
def build_chubb(mqtt: bool) -> ET.Element:
    ...
    rename_blocks(
        root,
        {
            # R1 spine a1→a9: JMRI path Main West → South Yard East via Brick/Plane
            "aBlock 1": "Main West",
            ...
            # not top A/B OS 117 (M2S1302 / South Yard Scale–T6 side).
            "aBlock 6": "OS 117b (Barn)",
            "aBlock 7": "Main East",
            "aBlock 8": "OS 112 (East End)",
            "aBlock 9": "South Yard East",
            ...
            # R2 yard body d1→d15 (Digicon-contiguous); no second South Yard East
            "dBlock 1": "OS 101 (Brick)",
            "dBlock 2": "OS 116",
            "dBlock 3": "OS 118",
            "dBlock 4": "OS 119",
            "dBlock 5": "South Yard West",
            "dBlock 6": "OS 117 (Barn)",  # TO117 top A/B (South Yard Scale/T6 side)
            "dBlock 7": "West Yard 1",
            "dBlock 8": "West Yard 2",
            "dBlock 9": "Engine House 1",
            "dBlock 10": "South Yard 1",
            "dBlock 11": "South Yard 2",
            "dBlock 12": "South Yard 3",
            "dBlock 13": "South Yard 4",
            "dBlock 14": "South Yard 5",
            "dBlock 15": "OS 111a (East End)",
            "dBlock 16": "OS 109 (East End)",
            "dBlack 17": "OS 110 (East End)",
            "dBlock 18": "OS 111b (East End)",
            "dBlock 19": "Engine House 2",
            # Engine House 3: keep on leftover Chubb name via explicit rename of fBlock 8
            "fBlock 8": "Engine House 3",
