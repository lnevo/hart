...
MASTER = ROOT / "cats/panels/HART_Master.xml"
MASTER_ABS = ROOT / "cats/panels/HART_Master_ABS.xml"
...
PLANTS: dict[tuple[int, int], tuple[str, str, str]] = {
    ...
    (13, 7): ("OS 117 (Barn)", "LEFT", "TO117"),
    (13, 8): ("OS 117b (Barn)", "RIGHT", "TO117"),
...
ANCHORS: list[tuple[int, int, str, str]] = [
    ...
    (10, 7, "LEFT", "South Yard Scale"),
    (11, 7, "RIGHT", "South Yard Scale"),
    (12, 7, "LEFT", "OS 117 (Barn)"),
    (9, 8, "RIGHT", "OS 102 (Plane)"),
    (10, 8, "LEFT", "East Main Ext"),
    (11, 8, "RIGHT", "East Main Ext"),
    (12, 8, "LEFT", "OS 117b (Barn)"),
    # Barn 117 / 117b (plants at 14,8 / 14,9)
    (13, 7, "BOTTOM", "OS 117 (Barn)"),
    (14, 7, "RIGHT", "OS 117 (Barn)"),
    (15, 7, "LEFT", "South Yard West"),
    (13, 8, "TOP", "OS 117b (Barn)"),
    (14, 8, "RIGHT", "OS 117b (Barn)"),
    (15, 8, "LEFT", "Main East"),
    ...
    (29, 8, "RIGHT", "South Yard 2"),
    (28, 9, "RIGHT", "South Yard 3"),
    (27, 10, "RIGHT", "South Yard 4"),
    # Princess
...
CUTS: list[tuple[tuple[int, int], str, tuple[int, int], str, str]] = [
    ...
    ((9, 7), "RIGHT", (10, 7), "LEFT", "OS102 | South Yard Scale"),
    ((9, 8), "RIGHT", (10, 8), "LEFT", "OS102 south | East Main Ext"),
    ((11, 8), "RIGHT", (12, 8), "LEFT", "East Main Ext | OS117b"),
    ((11, 7), "RIGHT", (12, 7), "LEFT", "South Yard Scale | OS117"),
    ((14, 7), "RIGHT", (15, 7), "LEFT", "OS117 tip | South Yard West"),
    ...
    ((17, 7), "RIGHT", (18, 7), "LEFT", "South Yard West | OS116"),
    ((19, 7), "RIGHT", (20, 7), "LEFT", "OS116 tip | OS103 tip"),
    ((21, 7), "RIGHT", (22, 7), "LEFT", "OS103 | South Yard 1 / S-1"),
    ((21, 7), "BOTTOM", (21, 8), "TOP", "OS103 spine"),
    ((22, 8), "RIGHT", (23, 8), "LEFT", "OS104 | South Yard 2"),
    ((22, 8), "BOTTOM", (22, 9), "TOP", "OS104 spine"),
    ((23, 9), "RIGHT", (24, 9), "LEFT", "OS105 | South Yard 3"),
    ((23, 9), "BOTTOM", (23, 10), "TOP", "OS105 spine"),
    ((24, 10), "RIGHT", (25, 10), "LEFT", "OS106 | South Yard 4"),
    ((24, 10), "BOTTOM", (24, 11), "TOP", "OS106 | South Yard 5"),
