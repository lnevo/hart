...
if exist "%USERPROFILE%\JMRI\HART_Master_ABS_hold.jmri" rmdir /S /Q "%USERPROFILE%\JMRI\HART_Master_ABS_hold.jmri" 2>nul
if exist "%APPDATA%\JMRI\HART_Master_ABS_hold.jmri" rmdir /S /Q "%APPDATA%\JMRI\HART_Master_ABS_hold.jmri" 2>nul
...
echo PANEL=%PANEL%
echo Starting CATS (HART Master ABS-RO hold)...
