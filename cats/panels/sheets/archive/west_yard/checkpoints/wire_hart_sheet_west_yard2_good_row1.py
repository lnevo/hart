...
ANCHORS: list[tuple[int, int, str, str]] = [
    ...
    (7, 4, "TOP", "Block 100-102"),
    (7, 6, "BOTTOM", "Block 100-102"),
...
CUTS: list[tuple[tuple[int, int], str, tuple[int, int], str, str]] = [
    ...
    ((7, 3), "BOTTOM", (7, 4), "TOP", "OS100 | Block 100-102"),
    ((7, 6), "BOTTOM", (7, 7), "TOP", "Block 100-102 | OS102"),
    ...
    ((13, 6), "RIGHT", (14, 6), "LEFT", "ET-3 mid"),
    ((13, 5), "RIGHT", (14, 5), "LEFT", "ET-2 mid"),
    ((14, 4), "RIGHT", (15, 4), "LEFT", "ET-1 mid"),
...
SIGNAL_DEFS: dict[tuple[int, int, str], tuple[str, str, str, str]] = {
    ...
    (4, 3, "LEFT"): ("Brick West West Yard 1", "LAMP1", "LOWLEFT", "RIGHT"),
    (4, 4, "LEFT"): ("Brick West West Yard 2", "LAMP1", "LOWLEFT", "RIGHT"),
    # Main / CP — double head
    ...
    (34, 7, "RIGHT"): ("East End East East Lead", "LAMP2", "LOWRIGHT", "LEFT"),
