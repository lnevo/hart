...
SoR: cats/panels/sheets/HART_sheet_West_Yard_SOR.xml
  ...
  HART_sheet_West_Yard.xml (launch_cats.sh default).
...
# Coords match Designer SoR after user gap/shift pass (SOR2 → SoR).
# NORMAL = continuing/CLOSED leg among non-points edges (must match SoR ROUTEINFO).
PLANTS: dict[tuple[int, int], tuple[str, str, str]] = {
    # Brick/WY on y=4; shaft (8,5–7) into Plane tip (8,8).
    (5, 4): ("OS 101 (Brick)", "LEFT", "TOL38"),
    (8, 4): ("OS 100 (Brick)", "LEFT", "TOL3"),
    (9, 8): ("OS 102 (Plane)", "BOTTOM", "TOL42"),
    (14, 8): ("OS 117 (West Yard)", "LEFT", "TO117"),
    (14, 9): ("OS 117b (West Yard)", "RIGHT", "TO117"),
    (16, 7): ("OS 119 (West Yard)", "LEFT", "TO10"),
    (18, 7): ("OS 118 (West Yard)", "LEFT", "TO11"),
    (19, 8): ("OS 116 (West Yard)", "LEFT", "TO1"),
    (22, 8): ("OS 103 (South Yard)", "RIGHT", "TOR14"),
    (23, 9): ("OS 104 (South Yard)", "BOTTOM", "TOL15"),
    (24, 10): ("OS 105 (South Yard)", "BOTTOM", "TOL17"),
    (25, 11): ("OS 106 (South Yard)", "BOTTOM", "TOL19"),
    (29, 11): ("OS 107 (East End)", "BOTTOM", "TOR11"),
    (30, 10): ("OS 108 (East End)", "BOTTOM", "TOR9"),
    (31, 9): ("OS 109 (East End)", "BOTTOM", "TOR7"),
    (32, 8): ("OS 110 (East End)", "LEFT", "TOL6"),
    (34, 8): ("OS 112 (East End)", "LEFT", "TOL23"),
    (30, 7): ("OS 111a (East End)", "RIGHT", "TO111"),
    (30, 8): ("OS 111b (East End)", "LEFT", "TO111"),
    (39, 7): ("OS 113b (Princess)", "LEFT", "TO113"),
    (39, 8): ("OS 113a (Princess)", "RIGHT", "TO113"),
    (43, 7): ("OS 115 (Princess)", "RIGHT", "TOL29"),
    (43, 8): ("OS 114 (Princess)", "RIGHT", "TOR36"),
}
...
ANCHORS: list[tuple[int, int, str, str]] = [
    ...
    (2, 4, "LEFT", "West Yard 1"),  # west-of-lamp stub region (named for R5)
    (4, 4, "LEFT", "OS 101 (Brick)"),
    (6, 4, "RIGHT", "OS 101 (Brick)"),
    (2, 5, "LEFT", "West Yard 2"),
    (4, 5, "LEFT", "OS 101 (Brick)"),
    (7, 4, "LEFT", "OS 100 (Brick)"),
    (8, 4, "BOTTOM", "OS 100 (Brick)"),
    (9, 4, "RIGHT", "OS 100 (Brick)"),
    # Main West: Brick tip → SE stair → EE
    (10, 4, "LEFT", "Main West"),
    (28, 7, "RIGHT", "Main West"),
    # Block 100-102 vertical into Plane
    (8, 5, "TOP", "Block 100-102"),
    (8, 7, "BOTTOM", "Block 100-102"),
    (8, 8, "TOP", "OS 102 (Plane)"),
    ...
    (10, 8, "RIGHT", "OS 102 (Plane)"),
    (11, 8, "LEFT", "Yard T1"),
    (12, 8, "RIGHT", "Yard T1"),
    (13, 8, "LEFT", "OS 117 (West Yard)"),
    (10, 9, "RIGHT", "OS 102 (Plane)"),
    (11, 9, "LEFT", "East Main Ext"),
    (12, 9, "RIGHT", "East Main Ext"),
    (13, 9, "LEFT", "OS 117b (West Yard)"),
    # Barn 117 / 117b (plants at 14,8 / 14,9)
    (14, 8, "BOTTOM", "OS 117 (West Yard)"),
    (15, 8, "RIGHT", "OS 117 (West Yard)"),
    (16, 8, "LEFT", "Yard T6"),
    (14, 9, "TOP", "OS 117b (West Yard)"),
    (15, 9, "RIGHT", "OS 117b (West Yard)"),
    (16, 9, "LEFT", "Main East"),
    # ET: Designer mid-spur cuts (not at plant throat — OS floods into 118/119)
    (13, 7, "LEFT", "ET-3"),
    (14, 7, "RIGHT", "ET-3"),
    (15, 7, "LEFT", "OS 119 (West Yard)"),
    # OS119 plant: approach names flood through SP — no plant-edge names (avoids
    # throat Digicon seams + R4 vs plain ET stubs).
    (17, 7, "RIGHT", "OS 119 (West Yard)"),
    (13, 6, "LEFT", "ET-2"),
    (14, 6, "RIGHT", "ET-2"),
    (15, 6, "LEFT", "OS 119 (West Yard)"),
    (13, 5, "LEFT", "ET-1"),
    (15, 5, "RIGHT", "ET-1"),
    (16, 5, "LEFT", "OS 118 (West Yard)"),
    (17, 7, "LEFT", "OS 118 (West Yard)"),
    (18, 7, "LEFT", "OS 118 (West Yard)"),
    (19, 7, "BOTTOM", "OS 118 (West Yard)"),
    (18, 8, "RIGHT", "Yard T6"),
    (19, 8, "TOP", "OS 116 (West Yard)"),
    (19, 8, "LEFT", "OS 116 (West Yard)"),
    (20, 8, "RIGHT", "OS 116 (West Yard)"),
    # South Yard (plants shifted +1)
    (21, 8, "LEFT", "OS 103 (South Yard)"),
    (22, 8, "RIGHT", "OS 103 (South Yard)"),
    (23, 8, "LEFT", "Yard Track 1"),
    (23, 9, "RIGHT", "OS 104 (South Yard)"),
    (24, 9, "LEFT", "Yard Track 2"),
    (24, 10, "RIGHT", "OS 105 (South Yard)"),
    (25, 10, "LEFT", "Yard Track 3"),
    (25, 11, "RIGHT", "OS 106 (South Yard)"),
    (26, 11, "LEFT", "Yard Track 4"),
    (25, 11, "BOTTOM", "OS 106 (South Yard)"),
    (25, 12, "TOP", "Yard Track 5"),
    # EE 111 / 110 / 112 (plants at 30,7/30,8 / 32,8 / 34,8)
    (29, 7, "LEFT", "OS 111a (East End)"),
    (30, 7, "BOTTOM", "OS 111a (East End)"),
    (31, 7, "RIGHT", "OS 111a (East End)"),
    (32, 7, "LEFT", "West Main Ext"),
    (28, 8, "RIGHT", "Yard Track 1"),
    (29, 8, "LEFT", "OS 111b (East End)"),
    (30, 8, "TOP", "OS 111b (East End)"),
    (31, 8, "RIGHT", "OS 111b (East End)"),
    (32, 8, "LEFT", "OS 110 (East End)"),
    (32, 8, "BOTTOM", "OS 110 (East End)"),
    (33, 8, "RIGHT", "OS 110 (East End)"),
    (31, 9, "LEFT", "OS 109 (East End)"),
    (30, 10, "LEFT", "OS 108 (East End)"),
    (29, 11, "LEFT", "OS 107 (East End)"),
    (34, 8, "LEFT", "OS 112 (East End)"),
    (35, 8, "RIGHT", "OS 112 (East End)"),
    # 112 south lamp on slash face (34,9) LEFT — continuous (33,9)↔(33,10) Main East
    (34, 9, "LEFT", "OS 112 (East End)"),
    (33, 9, "RIGHT", "Main East"),
    (36, 8, "LEFT", "East Lead"),
    (37, 8, "RIGHT", "East Lead"),
    (38, 8, "LEFT", "OS 113a (Princess)"),
    (38, 8, "RIGHT", "OS 113a (Princess)"),
    (30, 9, "RIGHT", "Yard Track 2"),
    (29, 10, "RIGHT", "Yard Track 3"),
    (28, 11, "RIGHT", "Yard Track 4"),
    # Princess
    (37, 7, "RIGHT", "West Main Ext"),
    (38, 7, "LEFT", "OS 113b (Princess)"),
    (39, 7, "BOTTOM", "OS 113b (Princess)"),
    (40, 7, "RIGHT", "OS 113b (Princess)"),
    (41, 7, "LEFT", "OS 115 (Princess)"),
    (39, 8, "LEFT", "OS 113a (Princess)"),
    (39, 8, "TOP", "OS 113a (Princess)"),
    (40, 8, "RIGHT", "OS 113a (Princess)"),
    (41, 8, "LEFT", "OS 114 (Princess)"),
    # K-2 continuous plant→(44,8); OS on approach floods through SP.
    # Cut only at McKeesport lamp — never mid-K-2.
    (44, 9, "RIGHT", "OS 114 (Princess)"),
    (45, 9, "LEFT", "McKeesport"),
    (46, 8, "TOP", "McKeesport"),
    # K-1 continuous plant→(44,7); cut only at Rocks lamp — never mid-K-1.
    (44, 6, "RIGHT", "OS 115 (Princess)"),
    (45, 6, "LEFT", "McKees Rocks"),
    (46, 7, "BOTTOM", "McKees Rocks"),
]

CUTS: list[tuple[tuple[int, int], str, tuple[int, int], str, str]] = [
    # West-rim lamp faces only — W-1/W-2 rail continuous into OS101 plant.
    ((3, 4), "RIGHT", (4, 4), "LEFT", "W-1 west lamp"),
    ((3, 5), "RIGHT", (4, 5), "LEFT", "W-2 west lamp"),
    ((6, 4), "RIGHT", (7, 4), "LEFT", "OS101 tip | OS100"),
    ((8, 4), "BOTTOM", (8, 5), "TOP", "OS100 | Block 100-102"),
    ((8, 7), "BOTTOM", (8, 8), "TOP", "Block 100-102 | OS102"),
    ((9, 4), "RIGHT", (10, 4), "LEFT", "OS100 tip | Main West"),
    ((10, 8), "RIGHT", (11, 8), "LEFT", "OS102 | Yard T1"),
    ((10, 9), "RIGHT", (11, 9), "LEFT", "OS102 south | East Main Ext"),
    ((12, 9), "RIGHT", (13, 9), "LEFT", "East Main Ext | OS117b"),
    ((12, 8), "RIGHT", (13, 8), "LEFT", "Yard T1 | OS117"),
    ((15, 8), "RIGHT", (16, 8), "LEFT", "OS117 tip | Yard T6"),
    ((14, 8), "BOTTOM", (14, 9), "TOP", "OS117 | OS117b diamond"),
    ((15, 9), "RIGHT", (16, 9), "LEFT", "OS117b | Main East"),
    # ET mid-spur (Designer) — continuous into OS118/119 throats
    ((14, 7), "RIGHT", (15, 7), "LEFT", "ET-3 mid"),
    ((14, 6), "RIGHT", (15, 6), "LEFT", "ET-2 mid"),
    ((15, 5), "RIGHT", (16, 5), "LEFT", "ET-1 mid"),
    ((17, 7), "RIGHT", (18, 7), "LEFT", "OS119 tip | OS118"),
    ((19, 7), "BOTTOM", (19, 8), "TOP", "OS118 | OS116"),
    ((18, 8), "RIGHT", (19, 8), "LEFT", "Yard T6 | OS116"),
    ((20, 8), "RIGHT", (21, 8), "LEFT", "OS116 tip | OS103 tip"),
    ((22, 8), "RIGHT", (23, 8), "LEFT", "OS103 | Yard Track 1 / S-1"),
    ((22, 8), "BOTTOM", (22, 9), "TOP", "OS103 spine"),
    ((23, 9), "RIGHT", (24, 9), "LEFT", "OS104 | Yard Track 2"),
    ((23, 9), "BOTTOM", (23, 10), "TOP", "OS104 spine"),
    ((24, 10), "RIGHT", (25, 10), "LEFT", "OS105 | Yard Track 3"),
    ((24, 10), "BOTTOM", (24, 11), "TOP", "OS105 spine"),
    ((25, 11), "RIGHT", (26, 11), "LEFT", "OS106 | Yard Track 4"),
    ((25, 11), "BOTTOM", (25, 12), "TOP", "OS106 | Yard Track 5"),
    ((28, 7), "RIGHT", (29, 7), "LEFT", "Main West | OS111a tip"),
    ((31, 7), "RIGHT", (32, 7), "LEFT", "OS111a | West Main Ext"),
    ((30, 7), "BOTTOM", (30, 8), "TOP", "OS111a | OS111b diamond"),
    ((28, 8), "RIGHT", (29, 8), "LEFT", "YT1/S-1 | OS111b"),
    ((31, 8), "RIGHT", (32, 8), "LEFT", "OS111b tip | OS110"),
    ((32, 8), "BOTTOM", (32, 9), "TOP", "OS110 spine"),
    ((30, 9), "RIGHT", (31, 9), "LEFT", "OS109 approach"),
    ((31, 9), "BOTTOM", (31, 10), "TOP", "OS109 spine"),
    ((29, 10), "RIGHT", (30, 10), "LEFT", "OS108 approach"),
    ((30, 10), "BOTTOM", (30, 11), "TOP", "OS108 spine"),
    ((28, 11), "RIGHT", (29, 11), "LEFT", "OS107 approach"),
    ((29, 11), "BOTTOM", (29, 12), "TOP", "OS107 spine"),
    ((33, 8), "RIGHT", (34, 8), "LEFT", "OS110 tip | OS112"),
    ((35, 8), "RIGHT", (36, 8), "LEFT", "OS112 tip | East Lead"),
    ((37, 8), "RIGHT", (38, 8), "LEFT", "East Lead | OS113a tip"),
    ((33, 9), "RIGHT", (34, 9), "LEFT", "OS112 south lamp"),
    ((37, 7), "RIGHT", (38, 7), "LEFT", "WME | OS113b"),
    ((39, 7), "BOTTOM", (39, 8), "TOP", "OS113b | OS113a diamond"),
    ((40, 8), "RIGHT", (41, 8), "LEFT", "OS113a | OS114 approach"),
    ((40, 7), "RIGHT", (41, 7), "LEFT", "OS113b tip | OS115"),
    ((44, 6), "RIGHT", (45, 6), "LEFT", "OS115 | McKees Rocks"),
    ((44, 9), "RIGHT", (45, 9), "LEFT", "OS114 | McKeesport"),
    ((46, 7), "BOTTOM", (46, 8), "TOP", "McKees Rocks | McKeesport"),
]
...
SIGNAL_DEFS: dict[tuple[int, int, str], tuple[str, str, str, str]] = {
    ...
    (4, 4, "LEFT"): ("Brick West West Yard 1", "LAMP1", "LOWLEFT", "RIGHT"),
    (4, 5, "LEFT"): ("Brick West West Yard 2", "LAMP1", "LOWLEFT", "RIGHT"),
    # Main / CP — double head
    (9, 4, "RIGHT"): ("Brick East Main West", "LAMP2", "LOWLEFT", "LEFT"),
    (44, 6, "RIGHT"): ("Princess North McKees Rocks", "LAMP3", "LOWLEFT", "LEFT"),
    (29, 7, "LEFT"): ("East End West Main West", "LAMP2", "LOWLEFT", "RIGHT"),
    (31, 7, "RIGHT"): ("East End East OS 111a", "LAMP2", "LOWLEFT", "LEFT"),
    (38, 7, "LEFT"): ("Princess West OS 113b", "LAMP2", "LOWLEFT", "RIGHT"),
    (10, 8, "RIGHT"): ("Plane East OS 102", "LAMP2", "LOWLEFT", "LEFT"),
    (13, 8, "LEFT"): ("West Yard West OS 117", "LAMP2", "LOWLEFT", "RIGHT"),
    (15, 8, "RIGHT"): ("West Yard East Yard T6", "LAMP1", "LOWLEFT", "LEFT"),
    (29, 8, "LEFT"): ("East End West Yard Track 1", "LAMP1", "LOWLEFT", "RIGHT"),
    (35, 8, "RIGHT"): ("East End East East Lead", "LAMP2", "LOWRIGHT", "LEFT"),
    (38, 8, "LEFT"): ("Princess West OS 113a", "LAMP2", "LOWLEFT", "RIGHT"),
    (32, 8, "BOTTOM"): ("East End South OS 110", "LAMP1", "UPLEFT", "RIGHT"),
    (10, 9, "RIGHT"): ("Plane East East Main Ext", "LAMP2", "LOWLEFT", "LEFT"),
    (13, 9, "LEFT"): ("West Yard West East Main Ext", "LAMP2", "LOWLEFT", "RIGHT"),
    (15, 9, "RIGHT"): ("West Yard East OS 117b", "LAMP2", "LOWLEFT", "LEFT"),
    (34, 9, "LEFT"): ("East End South OS 112", "LAMP2", "RIGHTUP", "RIGHT"),
    (44, 9, "RIGHT"): ("Princess South McKeesport", "LAMP3", "LOWLEFT", "LEFT"),
}
